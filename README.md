...
These are set of latex notes based off the notes I took for the C5: Physics of Atmospheres and Oceans course. You can access the course on the 'main.pdf' file above^ or clicking this [link](https://github.com/kenzhao20/C5-Notes/blob/main/main.pdf) (which leads to the same place).
