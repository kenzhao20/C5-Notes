...
\begin{align*}
    L_{\star}=\int_{\Omega_{Sun}}\int _0^\infty B_{sun}(T,\nu)\,d\nu\,d\Omega_\perp
\end{align*}
Calculating htis explicitly, we get:
\begin{align*}
    L_{\star}=\int_{\Omega_{Sun}} \frac{1}{\pi}\sigma T^4 \, d\Omega_\perp
\end{align*}

We do this by integrating the spectral radiance of the Sun over all frequencies (to obtain the radiance) and over the solid angle of the Sun from Earth (to obtain the irradiance):
\begin{align*}
