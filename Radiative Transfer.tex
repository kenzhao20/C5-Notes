...
Let us now solve this system as before, this time with the $E_\star$. Before we do that, we will redefine our coordinate system for convenience (which we are well within our rights to - see Section \ref{Absorption Section}).

\subsection{Derivation}

\subsubsection{Redefinition Our Coordinate System}
