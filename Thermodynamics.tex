...
We also introduce the concept of '\textit{dilute}': some constituent $a$ is in the dilute limit if and only if:
\begin{align*}
...
\subsection{Multiple Constituents in an Atmosphere and Dalton's Law}\label{Multiple}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{The 7 Degrees of Freedom for a Diatomic Molecules}
    \label{7DoF}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{The 5 Excited Degrees of Freedom for a Diatomic Molecules in Earth-Like Conditions}
\end{figure}
