...
The atmosphere can be roughly regarded as an ideal gas, so we can substitute in Equation \ref{eq Ideal Gas} to find that Equation \ref{Hydrostatic Balance} transforms into:
\begin{align}
...
\begin{fact}{The Dry Adiabat}{Dry Adiabat Box}\label{Dry Adiabat Box}
    ...
    \vspace{2mm} If we crucially assume that \textbf{convection} is the \textbf{dominant vertical energy transport mechanism} in the atmosphere then the \textbf{atmosphere follows a dry adiabat}. This is somewhat accurate for Earth's troposphere.
\end{fact}
...
Recalling that \(TdS=dQ=\) heat, we find that the potential temperature is a measure of the extent to which diabatic/heat transfer processes have heated or cooled our parcel of air. It can be a proxy for how wrong we were to assume that \(dS=0\) in our derivation of \hyperref[Dry Adiabat]{Dry Adiabat}.
