...
\begin{align}
    ...
    \right)
\end{align}
However, I'll mainly focus on the second method, and plot the response of the system to a linear injection of CO$_2$ into the atmosphere (i.e., we let $E(t)=0$ for $t<0$ and $E(t)=at$ for $t\geq 0$).
...
The timescale for which this system responds is a bit more complicated 
The response of the system is set by the timescale $t_b\sim\mathcal{O}\left(\frac{R_b}{s}\right)$, and 
