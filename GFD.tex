...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Paddleboard (\textcolor{mymagenta}{magenta triangle \rule{0.2cm}{0.2cm}}) demonstration of curl. The \textcolor{mydarkblue}{Dotted Blue Arrow \rule{0.2cm}{0.2cm}} indicates the direction of time evolution (the paddleboard is being advected by the velocity field $\vec{u}$).}
\end{figure}
