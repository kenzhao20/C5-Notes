...
\hbadness = 99999 %ignore underfull
...
%define CCancel to cancel using different colours
...
\usetikzlibrary{shapes.geometric,perspective,external,angles,quotes,patterns,decorations.pathmorphing,snakes}
...
(for \hyperref[p Thermodynamics]{Thermodynamics} and \hyperref[Radiative Transfer]{Radiative Transfer}), 
...
Also I've added some further info in the Appendix. Most 
